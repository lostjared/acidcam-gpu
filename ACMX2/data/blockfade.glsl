...
void main() {
    ...
    float maxTearDistance = 0.15; // Blocks can jump up to 15% across the screen
    vec2 uvDisplaced = tc + (blockOffset * intensity * maxTearDistance);
    uvDisplaced = clamp(uvDisplaced, 0.0, 1.0);
