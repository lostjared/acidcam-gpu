...
GlslSyntaxHighlighter::GlslSyntaxHighlighter(QTextDocument *parent) : QSyntaxHighlighter(parent) { initHighlightingRules(false); }
...
void GlslSyntaxHighlighter::initHighlightingRules(bool lightTheme) {
    ...
    QStringList keywordPatterns = {"\\bif\\b", "\\belse\\b", "\\bfor\\b", "\\bwhile\\b", "\\bdo\\b", "\\bbreak\\b", "\\bcontinue\\b", "\\breturn\\b", "\\bdiscard\\b", "\\bswitch\\b", "\\bcase\\b", "\\bdefault\\b", "\\bstruct\\b", "\\bconst\\b", "\\bin\\b", "\\bout\\b", "\\binout\\b", "\\buniform\\b", "\\bvarying\\b", "\\battribute\\b", "\\bcentroid\\b", "\\bflat\\b", "\\bsmooth\\b", "\\bnoperspective\\b", "\\blayout\\b", "\\bprecision\\b", "\\bhighp\\b", "\\bmediump\\b", "\\blowp\\b", "\\binvariant\\b", "\\bprecise\\b"};
    ...
    QStringList typePatterns = {"\\bvoid\\b", "\\bbool\\b", "\\bint\\b", "\\buint\\b", "\\bfloat\\b", "\\bdouble\\b", "\\bbvec2\\b", "\\bbvec3\\b", "\\bbvec4\\b", "\\bivec2\\b", "\\bivec3\\b", "\\bivec4\\b", "\\buvec2\\b", "\\buvec3\\b", "\\buvec4\\b", "\\bvec2\\b", "\\bvec3\\b", "\\bvec4\\b", "\\bdvec2\\b", "\\bdvec3\\b", "\\bdvec4\\b", "\\bmat2\\b", "\\bmat3\\b", "\\bmat4\\b", "\\bmat2x2\\b", "\\bmat2x3\\b", "\\bmat2x4\\b", "\\bmat3x2\\b", "\\bmat3x3\\b", "\\bmat3x4\\b", "\\bmat4x2\\b", "\\bmat4x3\\b", "\\bmat4x4\\b", "\\bdmat2\\b", "\\bdmat3\\b", "\\bdmat4\\b", "\\bsampler1D\\b", "\\bsampler2D\\b", "\\bsampler3D\\b", "\\bsamplerCube\\b", "\\bsampler1DShadow\\b", "\\bsampler2DShadow\\b", "\\bsampler1DArray\\b", "\\bsampler2DArray\\b", "\\bsampler2DRect\\b", "\\bsampler2DMS\\b", "\\bisampler1D\\b", "\\bisampler2D\\b", "\\bisampler3D\\b", "\\busampler1D\\b", "\\busampler2D\\b", "\\busampler3D\\b"};
    ...
    QStringList builtinPatterns = {"\\bradians\\b",
                                   "\\bdegrees\\b",
                                   "\\bsin\\b",
                                   "\\bcos\\b",
                                   "\\btan\\b",
                                   ...
                                   "\\btexelFetch\\b",
                                   "\\btexelFetchOffset\\b",
                                   "\\btextureProjOffset\\b",
                                   "\\btextureLodOffset\\b",
                                   "\\btextureGrad\\b",
                                   "\\btextureGradOffset\\b",
                                   "\\btextureProjGrad\\b",
                                   "\\btextureProjGradOffset\\b",
                                   "\\btextureSize\\b",
                                   "\\btextureQueryLod\\b",
                                   "\\btextureQueryLevels\\b",
                                   "\\btextureSamples\\b",
                                   "\\btextureGather\\b",
                                   "\\btextureGatherOffset\\b",
                                   ...
                                   "\\bfwidthFine\\b",
                                   "\\bfwidthCoarse\\b",
                                   "\\binterpolateAtCentroid\\b",
                                   "\\binterpolateAtSample\\b",
                                   "\\binterpolateAtOffset\\b",
                                   "\\bnoise1\\b",
                                   "\\bnoise2\\b",
                                   "\\bnoise3\\b",
                                   "\\bnoise4\\b",
                                   "\\bEmitVertex\\b",
                                   "\\bEndPrimitive\\b",
                                   "\\batomicCounterIncrement\\b",
                                   "\\batomicCounterDecrement\\b",
                                   "\\batomicCounter\\b",
                                   "\\batomicAdd\\b",
                                   "\\batomicMin\\b",
                                   "\\batomicMax\\b",
    ...
    QStringList constantPatterns = {"\\bgl_Position\\b",
                                    "\\bgl_PointSize\\b",
                                    "\\bgl_ClipDistance\\b",
                                    "\\bgl_VertexID\\b",
                                    "\\bgl_InstanceID\\b",
