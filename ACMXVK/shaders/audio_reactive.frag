...
// Increment 5E audio-metric reference shader. ACMXVK maps live RtAudio data
// into unused SpriteExtended channels while preserving the existing ABI:
...
void main() {
    ...
    float pulse = clamp(amp_smooth * 3.0 + amp_peak * 0.75, 0.0, 0.35);
